...
contextBridge.exposeInMainWorld('lockOn', {
  ...
  service: {
    ...
    listInvoices: (month: string) => ipcRenderer.invoke('service:listInvoices', month),
    downloadInvoiceBatch: (month: string) => ipcRenderer.invoke('service:downloadInvoiceBatch', month),

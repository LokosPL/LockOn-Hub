...
export const ROLE_DEFINITIONS: Record<UserRole, RoleDefinition> = {
  OWNER: {
    ...
    navigation: ['dashboard', 'service', 'meetings', 'browser', 'earnings', 'administration', 'customers', 'support', 'settings'],
  ...
  BOSS: {
    ...
    navigation: ['dashboard', 'service', 'meetings', 'browser', 'earnings', 'settings'],
  ...
  COORDINATOR: {
    ...
    navigation: ['dashboard', 'service', 'meetings', 'browser', 'settings'],
    canManageUpdates: false,
    canManageSettings: false,
    canUseSupportDesk: false,
    canPreviewRoles: false,
  ...
  SUPPORT: {
    ...
    navigation: ['dashboard', 'meetings', 'browser', 'customers', 'support', 'settings'],
    canManageUpdates: false,
    canManageSettings: false,
    canUseSupportDesk: true,
    canPreviewRoles: false,
  ...
  USER: {
    ...
    navigation: ['dashboard', 'service', 'meetings', 'customers', 'browser', 'settings'],
    canManageUpdates: false,
    canManageSettings: false,
    canUseSupportDesk: false,
    canPreviewRoles: false,
